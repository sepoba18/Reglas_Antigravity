...
- `GEMINI.md`: Reglas del proyecto y directrices de desarrollo.
- `CURRENT_TASK.md`: Registro de estado de sincronización entre computadores.
- `.agents/skills/mi-skill/SKILL.md`: Skill modular del proyecto.

## Pruebas y Comandos
- Ninguno pendiente actualmente.
